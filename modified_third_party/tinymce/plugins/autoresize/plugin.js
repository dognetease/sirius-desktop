...
(function() {
    ...
    var resize = function(editor, oldSize) {
        ...
        var docEleH = docEle.offsetHeight;
        var docH = docEleH;
        if (docBody) {
            var docBodyH = docBody.scrollHeight;
            var docH = Math.max(docBodyH, docEleH);
        }
        var contentHeight = docH + marginTop + marginBottom + resizeBottomMargin;
        if (contentHeight < 0) {
            contentHeight = 0;
        }
