 ...
 */
 (function () {
  ...
  var applyList = function (editor, listName, detail) {
    ...
    global$5.each(selectedTextBlocks, function (block) {
      ...
      if (!isListItemNode(parent)) {
        ...
        // 1.28 需求减少ul ol 的padding-left
        dom.setStyle(listBlock, 'padding-left', '25px');
  ...
  var toggleMultipleLists = function (editor, parentList, lists, listName, detail) {
    ...
    if (parentIsList && parentList.nodeName === listName) {
  ...
  var toggleSingleList = function (editor, parentList, listName, detail) {
    ...
    if (parentList) {
      if (parentList.nodeName === listName && !isCustomList(parentList)) {
        //原代码 if (parentList.nodeName === listName && !hasListStyleDetail(detail) && !isCustomList(parentList)) {
        flattenListSelection(editor);
      } else {
        var bookmark = createBookmark(editor.selection.getRng(true));
