if(typeof window=="undefined"){self=global;}
if(!self.window){window=self;}
(function(window){'use strict';var $jscomp = {scope:{}}, goog = goog || {};
  goog.global = this;
  ...
  goog.iter.GroupByIterator_ = function(iterable, opt_keyFunc) {
    this.iterate = goog.iter.toIterator(iterable);
...
*/
  ...
  lf.schema.Builder.prototype.connect = function(opt_options) {
    ...
    return this.db_.init().then(function(db) {
      this.connectInProgress_ = !1;
      return db;
    }.bind(this), function(e) {
      this.connectInProgress_ = !1;
  ...
  try{if(module){module.exports=lf;}}catch(e){}}.bind(window))(window);
