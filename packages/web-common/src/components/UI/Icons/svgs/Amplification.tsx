...
const AmplificationIcon: React.FC<any> = (props: any) => {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" {...attribute}>
      <path
        ...
        strokeWidth="1.8"
      />
      <path d="M12 7.73438L12 16.2656" stroke={stroke} strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M7.73438 12H16.2656" stroke={stroke} strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  );
};

export default AmplificationIcon;
