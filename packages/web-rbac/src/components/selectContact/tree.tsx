...
import { getContact } from '@web-contact/_mock_';
import '@web-common/components/UI/SiriusContact/tree/index.scss';
import { ContactItem, getTeamMembers, transContactModel2ContactItem, UIContactModel } from '@web-common/components/util/contact';
...
const ContactTree: React.FC<ContactTreeProp> = props => {
  const {
    ...
    showCheckbox = true,
    itemHeight = 32,
    enterpriseRootName = '企业通讯录',
    showAddOrgBtn = true,
    showAvatar = true,
    personalRootName = '个人通讯录',
    teamRootName = '我的群组',
  } = props;
