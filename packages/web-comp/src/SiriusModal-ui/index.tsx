...
const Modal: ISiriusModal & React.FC<IProps> = props => {
        ...
        footer: (
          <div className={styles.deFooter}>
            <Button
              ...
              {...(cancelButtonProps as Omit<typeof cancelButtonProps, 'size' | 'type' | 'loading'>)}
            >
              取消
            </Button>
            <Button
              ...
              {...(okButtonProps as Omit<typeof okButtonProps, 'size' | 'type' | 'loading'>)}
            >
              确定
            </Button>
          </div>
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const antModalHeader: HTMLDivElement = document.querySelector('.sirius-modal-wrap>.lx-ant-modal-content>.lx-ant-modal-header') as HTMLDivElement;
      const antModalFooter: HTMLDivElement = document.querySelector('.sirius-modal-wrap>.lx-ant-modal-content>.lx-ant-modal-footer') as HTMLDivElement;
  ...
  const fresh = () => {
    ...
    const antModalBody: HTMLDivElement = document.querySelector('.sirius-modal-wrap>.lx-ant-modal-content>.lx-ant-modal-body') as HTMLDivElement;
    if (antModalBody) {
