...
import classes from './personalTemplateMultiSelectContent.module.scss';
...
const personalTemplateMultiSelectContent: React.FC<Props> = ({
  dataList,
  selectedIds,
  onCheckedChange,
  createItems,
...
export default personalTemplateMultiSelectContent;
