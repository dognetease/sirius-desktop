...
// const cssnano = require('./postcss-nice-cssnano-plugin');
...
try {
  fs.accessSync('./config/fast_build/ignore-module.json');
  const res = require('./config/fast_build/ignore-module.json');
...
const hostMap = {
  ...
  // test: 'https://sirius-test1.qiye.163.com',
