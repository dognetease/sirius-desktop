  ...
  if (propsHeadComponents) {
    ...
    propsHeadComponents = propsHeadComponents.filter(component => {
      if (component && component.type === 'style' && component.props) {
        const isGlobalCss = component.props.id === 'gatsby-global-css' || component.props['data-identity'] === 'gatsby-global-css';
        if (isGlobalCss) {
  ...
  return (
    <html lang="zh" {...props.htmlAttributes}>
      <head>
        ...
        <link rel="shortcut icon" href={SUB_PATH + '/favicon.png'} type="image/x-icon" />
        <script
        ...
        {!isBuildingEdm && <link rel="stylesheet" href={SUB_PATH + '/ant-dark-2023-09-18.css'} type="text/css" />}
          ...
          <script
            ...
            if(global_inWindow){
              (function (w, d, n, a, j) {
                ...
                j.async = true;
                j.src ='https://qiyukf.com/script/abab5b9989e6f898240067f40874a096.js?hidden=1';
