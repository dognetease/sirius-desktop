...
export interface formListItem {
  ...
  ruleType?: string | number | boolean | 'url' | 'email';
}
...
const customerFormList: customerFormListType = [
  {
    type: 'Complex',
...
const customerContactList: customerFormListType = [
  {
    type: 'Radio',
    name: 'main_contact',
    maxLength: 100,
  ...
  },
  {
    ...
    ruleType: 'email',
    required: true,
    message: getIn18Text('QINGSHURUZHENGQUEYOUXIANGDEZHI'),
