...
export const Loading = () => (
  <div className="sirius-spin" style={{ width: 24, height: 24, margin: '0 auto' }}>
...
export const PageLoading = ({ style }: { style?: CSSProperties }) => (
  <div className={styles.pageLoading} style={style}>
    <Spin tip={getIn18Text('ZHENGZAIJIAZAIZHONG...')} indicator={<Loading />} />
  </div>
);
