...
var _util = require('./rc-tree/src/util');

var _treeUtil = require('./rc-tree/src/utils/treeUtil');
...
var DirectoryTree = function DirectoryTree(_a, ref) {
  ...
  var onSelect = function onSelect(keys, event) {
    ...
    if (multiple && ctrlPick) {
      ...
      newSelectedKeys = Array.from(
        new Set(
          [].concat(
            (0, _toConsumableArray2['default'])(cachedSelectedKeys.current || []),
            (0, _toConsumableArray2['default'])(
              (0, _dictUtil.calcRangeKeys)({
                treeData: treeData,
  ...
  var connectClassName = (0, _classnames['default'])(
    ''.concat(prefixCls, '-directory'),
    (0, _defineProperty2['default'])({}, ''.concat(prefixCls, '-directory-rtl'), direction === 'rtl'),
    className
  );
