...
import { apiHolder as api, apis, util as apiUtil, wait, SystemApi, MailConfApi } from 'api';
...
const ReadMailPage: React.FC<PageProps> = props => {
  ...
  // 营销邮件回复邮箱非本账号邮箱
  const edmReplyConfig = useRef<{ edmEmailId: string; operateId?: string; bounceId?: string } | null>(
