...
import { ChildrenType } from '@web-entry-ff/layouts/config/topMenu';
  ...
  return (
    <div
      className={classnames(styles.container, styles.specialModule, {
        ...
        [styles.wmdata]: props.dropMenuItem.path === TopMenuPath.wmData,
        [styles.unitableCrm]: props.dropMenuItem.path === TopMenuPath.unitable_crm,
        [styles.wmData]: props.dropMenuItem.path === TopMenuPath.wmData,
