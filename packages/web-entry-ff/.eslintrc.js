...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-use-before-define': ['off', { functions: true, classes: false, variables: true }],
    ...
    'no-shadow': 'off',
    '@typescript-eslint/no-shadow': ['off', { builtinGlobals: false, allow: ['done', 'reject', 'resolve', 'decode', 'encode'] }], //
    ...
    'max-len': ['error', { code: 200 }], // shisheng,最大宽度170,写超了想办法折行
