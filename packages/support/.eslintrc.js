module.exports = {
  ...
  ignorePatterns: ['node_modules', 'packages/*/node_modules'],
  ...
  rules: {
    ...
    'react/jsx-props-no-spreading': 'warn', // zoumingliang
    'import/no-extraneous-dependencies': ['warn', { packageDir: ['./packages/web', './', './packages/api', './packages/electron'] }],
    'no-shadow': 'off',
    '@typescript-eslint/no-shadow': ['error'], // shisheng,避免命名覆盖了上层的全局函数，但是使用中却未注意，此外无重命名的覆盖变量会增加代码可读性
