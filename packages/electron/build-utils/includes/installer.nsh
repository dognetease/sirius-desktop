...
!macro removeSendToLink
   WinShell::UninstShortcut "$sendToShortcutName"
   Delete "$sendToShortcutName"
!macroend

!macro addSendToLink
   !insertmacro removeSendToLink
   ClearErrors
   CreateShortCut "$sendToShortcutName" "$appExe" "--send-as-attachment" "$appExe" 0 "" "" "${APP_DESCRIPTION}"
!macroend
