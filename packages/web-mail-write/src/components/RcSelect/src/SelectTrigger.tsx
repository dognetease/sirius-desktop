...
const SelectTrigger: React.RefForwardingComponent<RefTriggerProps, SelectTriggerProps> = (props, ref) => {
  const {
    prefixCls,
    disabled,
    visible,
  ...
  const builtInPlacements = React.useMemo(() => getBuiltInPlacements(dropdownMatchSelectWidth), [dropdownMatchSelectWidth]);
