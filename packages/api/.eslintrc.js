module.exports = {
  ...
  rules: {
    ...
    'class-methods-use-this': 'off', // shisheng,不使用this的class函数通常可以写成static的，但是强制执行这条没太多收益，改成警告 // mlzou 改成off，vscode warn恶心
    camelcase: 'warn', // mlzou，不使用驼峰命名。强制执行这条没太多收益，改成警告
    'no-useless-escape': 'warn',
    '@typescript-eslint/no-namespace': 'off', // 放开命名空间，防止全局命名污染
