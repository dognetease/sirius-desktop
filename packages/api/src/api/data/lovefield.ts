...
export namespace lf {
  ...
  export type bind = (index: number) => Binder;
  ...
  namespace raw {
    export interface BackStore {
      ...
      addTableColumn(tableName: string, columnName: string, defaultValue: string | boolean | number | Date | ArrayBuffer): Promise<void>;
  ...
  export namespace schema {
    ...
    export interface TableBuilder {
      ...
      addIndex(name: string, columns: Array<string> | Array<IndexedColumn>, unique?: boolean, order?: Order): TableBuilder;
    ...
    export declare function create(dbName: string, dbVersion: number): Builder;
  } // module schema

  export namespace op {
    export declare function and(...args: Predicate[]): Predicate;

    export declare function not(operand: Predicate): Predicate;

    export declare function or(...args: Predicate[]): Predicate;
  } // module op

  export namespace fn {
    export declare function avg(column: schema.Column): schema.Column;

    export declare function count(column?: schema.Column): schema.Column;

    export declare function distinct(column: schema.Column): schema.Column;

    export declare function geomean(column: schema.Column): schema.Column;

    export declare function max(column: schema.Column): schema.Column;

    export declare function min(column: schema.Column): schema.Column;

    export declare function stddev(column: schema.Column): schema.Column;

    export declare function sum(column: schema.Column): schema.Column;
  } // module
} // module lf
